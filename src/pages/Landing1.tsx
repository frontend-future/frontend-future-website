...
export default function Landing1() {
  ...
  return <main className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <footer className="border-t border-slate-200 px-4 py-10 text-center text-xs text-slate-500">
        ...
        <div className="mt-4">
          © 2025 Turbo Scale, LLC — FrontendFuture · <a href="/terms" className="underline">Terms</a> · <a href="/privacy" className="underline">Privacy</a> · <a href="/accessibility" className="underline">Accessibility</a> · <a href="https://www.youtube.com/@frontendfuture" target="_blank" rel="noopener noreferrer" className="underline">Watch more on YouTube</a>
        </div>
      </footer>
    </main>;
}