  ...
  return <main className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <FAQItem q="How long does it take to land a job after completing the training?" a="Job timelines vary from student to student, since factors like consistency, application volume, and interview preparation all play a role. While we cannot legally guarantee employment, we provide continued job-search support every step of the way, including coaching, application reviews, interview prep, and guidance during your internship project. We also offer a money-back guarantee if you complete the required steps and do not secure a role within the terms outlined in the agreement, giving students added confidence as they work toward their goals." />
