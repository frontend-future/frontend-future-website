        ...
        ease: [0.22, 1, 0.36, 1]
          ...
          <div className="bg-slate-50 border-t border-slate-200 p-3 md:p-6">
            <div className="flex items-center justify-between gap-2">
              ...
              {isFinalStep ? <button data-tf-popup="01K6Y7Y8CMPZE5YYWS6SM4HMDG" data-tf-opacity="100" data-tf-size="100" data-tf-iframe-props="title=Application Form" data-tf-transitive-search-params data-tf-medium="snippet" className="flex-1 md:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg font-bold text-[#00131a] shadow-lg transition-all hover:shadow-xl hover:scale-105 text-xs md:text-base" style={{
              backgroundColor: ACCENT
            }}>
                  <span>🚀</span>
                  <span>Start Now</span>
